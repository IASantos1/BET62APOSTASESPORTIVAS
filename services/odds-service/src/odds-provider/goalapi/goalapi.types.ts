...
export interface GoalApiFixture {
  ...
  matchStatus?: GoalApiFixtureStatus | string | null;
  matchLive?: string | number | boolean | null;
  matchMinute?: string | number | null;
  matchElapsed?: string | number | null;
  matchExtra?: string | number | null;
  ...
  homeTeamExtraScore?: string | number | null;
  ...
  awayTeamExtraScore?: string | number | null;
  ...
  fkStageKey?: string | number | null;
  stageName?: string | null;
  videosCheckedAt?: string | null;
