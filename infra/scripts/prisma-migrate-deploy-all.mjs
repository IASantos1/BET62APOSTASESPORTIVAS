...
console.log('');
console.log(`=== BET62 PRISMA MIGRATE DEPLOY ALL (${prismaServices.length} servicos) ===`);
...
for (const svc of prismaServices) {
  ...
  process.stdout.write(`> MIGRATE DEPLOY  ${svc} ...  `);
  try {
...
console.log('');
console.log('============================================');
console.log('  PRISMA MIGRATE DEPLOY - RESUMO:');
